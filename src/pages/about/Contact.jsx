        ...
        <div className="min-h-screen py-16 px-4 sm:px-6 lg:px-8 flex flex-col items-start">
            <div className="w-full flex justify-center mb-16">
                <div className="w-full max-w-5xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    <button className="bg-[#F5F5A3] text-[#1E2B32] font-semibold px-6 py-3 rounded-md hover:opacity-90 transition w-full">
                        {t("about-page.contact.allClinics")}
                    </button>
                    <button className="bg-[#F5F5A3] text-[#1E2B32] font-semibold px-6 py-3 rounded-md hover:opacity-90 transition w-full">
                        {t("about-page.contact.allSpecialists")}
                    </button>
                    <button className="bg-[#F5F5A3] text-[#1E2B32] font-semibold px-6 py-3 rounded-md hover:opacity-90 transition w-full">
                        {t("about-page.contact.allCommunities")}
                    </button>
                </div>
            </div>
            ...
            <div className="w-full max-w-lg text-left bg-white rounded-2xl shadow-sm p-6 sm:p-10">
                <h1 className="text-2xl sm:text-3xl font-bold text-[#1E2B32] mb-8">
                    {t("about-page.contact.contactInfo")}
                </h1>

                <div className="mb-6">
                    <p className="font-semibold text-[#1E2B32] mb-2">{t("about-page.contact.phone")}</p>
                ...
                <div className="mb-6">
                    <p className="font-semibold text-[#1E2B32] mb-2">{t("about-page.contact.email")}</p>
                ...
                <div>
                    <p className="font-semibold text-[#1E2B32] mb-2">{t("about-page.contact.address")}</p>
                    <p className="text-[#1E2B32] font-medium">{t("about-page.contact.addressValue")}</p>
                </div>
            </div>
        </div>
    );
